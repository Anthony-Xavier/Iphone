function Intro() {
  const specs = [
    { value: "6.2", label: "Display Super Retina XDR", color: "text-blue-600" },
  ...
  return (
    <section className="bg-black py-20 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300m max-w-3xl mx-auto">
          O design mais refinado que já criamos. Titânio de grau
          aeroespacial.Chip A18 Pro. Sistema de câmera Pro revolucionário
        </p>
      </div>
